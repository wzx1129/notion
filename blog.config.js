...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '27151741160780ce85e4c55c46c60c53,en:d89e0a453b474db2a835e6cc8972fecb',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zhang-xiang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭🍚人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wwwhome.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'zhangxiang,博客,工作与生活', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '苏ICP备2025211927号', // 备案号 苏ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '苏公网安备32010602012185号', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个banker, Hi，我是一个普通人,Hi，我是一个干饭人,欢迎来到我的🎉',
